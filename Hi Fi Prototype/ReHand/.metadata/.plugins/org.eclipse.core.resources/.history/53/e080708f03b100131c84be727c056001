...
public class RadialDeviationResult extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(gettingStarted){
			...
			testTypeText.setText("You Have Completed Radial Deviation Exercise!");
		}
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
	           public void onClick(DialogInterface dialog, int id) {
	        	...
	        	SharedPreferences prefs = getBaseContext().getSharedPreferences("com.example.rehand", Context.MODE_PRIVATE);
	       		prefs.edit().putString("radialDeviation", "Done").commit();
	       		...
	       		if(gettingStarted){
	    			...
	    			db.updateResult(radialDeviationResult);
	    		}
