	...
	*/	
	...
	public void onSensorChanged(SensorEvent event){
	    ...
	    if(timer/5 == 1){
			...
			//mLastY = deltaY;
			mLastZ = deltaZ;
			ProgressBar bar = (ProgressBar) findViewById(R.id.timeProgress);
			//System.out.println((int) ((timer-25)*100.0/50));
	        bar.setProgress((int) ((timer-25)*100.0/50));
	    	...
	    	if(endPosition < startPosition){
	    		score = 360-startPosition+endPosition;
	    	}else{
