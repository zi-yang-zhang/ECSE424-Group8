...
public class FingerGripProgressDetailPage extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_finger_grip_progress_detail_page);
		...
		double currentProgress = fingerGripResult.getCurrentProgress();
		double personalBest = fingerGripResult.getPersonalBest();
		int level = fingerGripResult.getLevel();
		double benchmark = fingerGripResult.getBenchmark();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater()
				.inflate(R.menu.finger_grip_progress_detail_page, menu);
		return true;
	}
