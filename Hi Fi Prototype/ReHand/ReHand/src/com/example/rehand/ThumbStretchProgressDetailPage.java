...
public class ThumbStretchProgressDetailPage extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_thumb_stretch_progress_detail_page);
		...
		benchmarkText.setText(String.valueOf(f.format(benchmark))+"cm");
		levelText.setText(String.valueOf(level));
		personalBestScore.setText(String.valueOf(f.format(personalBest))+"cm");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.thumb_stretch_progress_detail_page,
				menu);
		return true;
	}
