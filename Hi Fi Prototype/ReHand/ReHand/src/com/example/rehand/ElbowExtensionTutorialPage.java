...
public class ElbowExtensionTutorialPage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Uri video = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.elbow_extension); //do not add any extension
		...
		videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
		    public void onCompletion(MediaPlayer mp) {
		    	Intent exerciseWithTutorial = new Intent(getBaseContext(), ElbowExtensionPage.class);
